...
## You will learn
  ...
  - How to deploy an MDK project to Mobile Services and run it in mobile client
...
5. Enter the project name `mdkapp` (used for this tutorial) , add a description (optional), and click **Create**. 
